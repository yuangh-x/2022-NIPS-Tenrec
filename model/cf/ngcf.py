...
class NGCF(GeneralRecommender):
    def __init__(self, args):
        ...
        self.hidden_size_list = args.hidden_size_list if args.hidden_size_list is not None else [64, 64, 64]
        self.hidden_size_list = [self.embedding_size] + self.hidden_size_list

        self.node_dropout = args.node_dropout
        self.message_dropout = args.mess_dropout
    ...
    def forward(self):
        ...
        return user_all_embeddings, item_all_embeddings #pred.view(-1) #
