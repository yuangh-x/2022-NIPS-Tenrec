...
class CpRec1(nn.Module):
    ...
    def __init__(self, args): #config, dataset
        super(CpRec1, self).__init__()#config, dataset
        ...
        # self.emb_hidden_map = nn.Linear(self.embedding_size, self.residual_channels)
    ...
    def forward(self, item_seq):
        ...
        # if self.embedding_size != self.residual_channels:
        #     item_seq_emb = self.emb_hidden_map(item_seq_emb)
