...
class ResidualBlock_a(nn.Module):
    ...
    def __init__(self, in_channel, out_channel, reader, kernel_size=3, dilation=None):
...
class ResidualBlock_b(nn.Module):
    ...
    def __init__(self, in_channel, out_channel, kernel_size=3, dilation=None): #, reader
