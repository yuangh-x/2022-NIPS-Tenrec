...
class DIEN(BaseModel):
    ...
    def __init__(self,
                 ...
                 gru_type="GRU", use_negsampling=False, alpha=1.0, use_bn=False, dnn_hidden_units=(256, 256),
                 dnn_activation='relu',
                 att_hidden_units=(64, 64), att_activation="relu", att_weight_normalization=True,
...
class InterestExtractor(nn.Module):
    ...
    def forward(self, keys, keys_length, neg_keys=None):
        ...
        #masked_keys_length = masked_keys_length.cpu()
